...
const goToPage = async (page: number) => {
    ...
    try {
        const res = await fetch(
            `/kecamatan/relawan/${props.relawan.id}/pemilihs?page=${page}`,
            {
                headers: {
...
if (typeof window !== 'undefined' && user) {
    ...
    useEcho(
        ...
        (event: TeamChangedEvent) => {
            ...
            if (
                event.event === 'deleted' ||
                event.kecamatanId !== user.kecamatan_id
            ) {
        ...
        <div class="flex w-full flex-col gap-6">
            ...
            >
                ...
                >
                    ...
                    <div
                        class="min-w-[280px] rounded-xl border border-amber-100/30 bg-amber-50/5 p-4"
                    >
                        <div
            ...
            >
                ...
                <div class="relative overflow-x-auto">
                    ...
                    <table class="w-full text-left text-sm text-gray-500">
                        <thead class="border-b border-amber-100/30 bg-amber-50/30 font-semibold text-amber-800">
                            <tr>
                                ...
                                <th class="w-[80px] px-4 py-3 text-center">
                                    RT/RW
                                </th>
