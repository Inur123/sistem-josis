...
if (typeof window !== 'undefined' && user) {
    useEcho(
        `kecamatan.pemilih.${user.kecamatan_id}`,
        'PemilihChanged',
        reloadRelawans,
    );
    useEcho(
        `kecamatan.team.${user.kecamatan_id}`,
        'TeamChanged',
        reloadRelawans,
    );
}
    ...
    <div class="flex flex-col gap-5 p-6">
        ...
        >
            ...
            <div class="w-full sm:w-64">
                <select
                    ...
                    class="border-gray-250 w-full rounded-lg border bg-white px-3 py-2 text-sm focus:border-amber-400 focus:outline-none"
                >
        ...
        <div class="flex flex-col gap-6">
                ...
                >
                    <div>
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <span
                                class="inline-flex items-center rounded border border-amber-100 bg-amber-50/10 px-2 py-0.5 text-xs text-amber-800"
                            >
                                Desa {{ r.desa }}
                            </span>
                            <Link
                    ...
                    <table class="w-full text-xs lg:text-sm">
                        ...
                        <tbody class="divide-y divide-amber-50/40">
                            <tr
                                ...
                                @click="
                                    router.visit(
                                        kecamatanRoutes.relawan.pemilih.show.url(
            ...
            <div
                ...
                class="rounded-xl border border-amber-100/50 bg-white p-12 text-center text-sm text-gray-500 shadow-sm"
            >
