...
async function goToPage(relawan: Relawan, page: number) {
    ...
    try {
        const res = await fetch(
            `/kecamatan/relawan/${relawan.id}/pemilihs?page=${page}`,
            {
                headers: {
...
<template>
    <Head title="Data Relawan (Kecamatan)" />
        ...
        >
            <div class="flex flex-col gap-1">
                <h2 class="text-xl font-bold text-gray-900">
                    Data Relawan — Kec. {{ props.kecamatan }}
                </h2>
                <p class="text-sm text-gray-500">
                    Daftar relawan dan kontribusi data pemilih mereka di wilayah
                    kecamatan Anda
                </p>
            </div>
            ...
            <div class="w-full sm:w-64">
                <select
                    ...
                    class="border-gray-250 w-full rounded-lg border bg-white px-3 py-2 text-sm focus:border-blue-500 focus:outline-none"
                >
                ...
                >
                    <div>
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <span
                                class="inline-flex items-center rounded border border-gray-200 bg-gray-50 px-2 py-0.5 text-xs text-gray-600"
                            >
                                Desa {{ r.desa }}
                            </span>
                            <Link
                    ...
                    <table class="w-full text-xs lg:text-sm">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <tr
                                ...
                                @click="router.visit(kecamatanRoutes.relawan.pemilih.show.url({ relawan: r.id, pemilih: p.id }, { query: { from: 'index', desa_id: selectedDesa || undefined } }))"
                            >
                                ...
                                <td class="px-2 py-3 text-center">
                                    <div class="flex items-center justify-center">
                                        <Link
                                            :href="kecamatanRoutes.relawan.pemilih.show.url({ relawan: r.id, pemilih: p.id }, { query: { from: 'index', desa_id: selectedDesa || undefined } })"
