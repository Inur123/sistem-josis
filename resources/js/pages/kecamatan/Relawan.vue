...
return;
    ...
    try {
        const res = await fetch(`/kecamatan/relawan/${relawan.id}/pemilihs?page=${page}`, {
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex flex-col gap-1">
                ...
                <p class="text-sm text-gray-500">
                    Daftar relawan dan kontribusi data pemilih mereka di wilayah kecamatan Anda
                </p>
            </div>
            ...
            <div class="w-full sm:w-64">
                <select
                    ...
                    class="w-full rounded-lg border border-gray-250 bg-white px-3 py-2 text-sm focus:border-blue-500 focus:outline-none"
                >
                ...
                <div class="flex flex-col justify-between border-b border-gray-100 pb-4 sm:flex-row sm:items-center gap-4">
                    <div>
                        <div class="flex items-center gap-2 flex-wrap">
                            ...
                            <span class="inline-flex items-center rounded bg-gray-50 px-2 py-0.5 text-xs border border-gray-200 text-gray-600">
                                Desa {{ r.desa }}
                            </span>
                        </div>
