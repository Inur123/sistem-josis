            ...
            <div class="mt-3 space-y-2 text-sm">
                <div class="rounded-lg border border-gray-100 bg-gray-50/50 p-3">
                    <div class="flex flex-col gap-1.5 sm:flex-row sm:items-center">
                        <span class="inline-flex items-center gap-1.5 font-semibold text-gray-700 min-w-[200px]">
                            <span class="h-1.5 w-1.5 rounded-full bg-blue-500"></span>
                            Koordinator Kecamatan (Korcam):
                        </span>
                        <span class="text-gray-600">
                            {{ props.korcams.length ? props.korcams.join(', ') : '-' }}
                        </span>
                    </div>
                    <div class="mt-2 flex flex-col gap-1.5 sm:flex-row sm:items-start border-t border-gray-100/80 pt-2">
                        <span class="inline-flex items-center gap-1.5 font-semibold text-gray-700 min-w-[200px] sm:pt-0.5">
                        ...
                        <div class="flex-1 flex flex-wrap gap-1.5">
                            <template v-if="props.kordes.length">
                                <span
                                    ...
                                    :key="k.nama"
                                    class="inline-flex items-center gap-1 rounded bg-white px-2 py-0.5 text-xs border border-gray-150 text-gray-600 shadow-sm"
                                >
                                    <span class="font-medium text-gray-800">{{ k.nama }}</span>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="px-5 py-3 text-center">
                                <Link
                                    :href="kecamatanRoutes.pemilih.index.url({ query: { desa_id: item.id } })"
