...
const exportExcel = async () => {
    ...
    try {
        const res = await fetch(adminRoutes.akun.export.url(), {
            headers: {
        ...
        link.href = url;
        link.setAttribute('download', 'Daftar_Akun_Josis.xlsx');
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <tr v-for="user in props.users" :key="user.id" class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-gray-600">
                                <span v-if="user.role === 'admin'">Seluruh Kabupaten</span>
                                <span v-else-if="user.role === 'kecamatan'">Kec. {{ user.kecamatan }}</span>
                                <span v-else-if="user.role === 'desa'">Kec. {{ user.kecamatan }} &raquo;
                                    {{ user.desa }}</span>
                            </td>
                            <td class="px-4 py-3">
            ...
            <div class="w-full max-w-md rounded-xl bg-white p-6 shadow-lg">
                ...
                <form @submit.prevent="submitForm" class="flex flex-col gap-4">
                    ...
                    <div v-if="form.role !== 'admin'" class="flex flex-col gap-1">
                        ...
                        <span v-if="form.errors.kecamatan_id" class="text-xs text-red-500">{{ form.errors.kecamatan_id
                        }}</span>
                    </div>
                    ...
                    <div v-if="form.role === 'desa'" class="flex flex-col gap-1">
                        ...
                        <span v-if="form.errors.desa_id" class="text-xs text-red-500">{{ form.errors.desa_id }}</span>
                    </div>
