...
<template>
    ...
    <div class="p-6">
        <div class="w-full">
            ...
            >
                    ...
                    <div class="flex gap-2">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-xs text-red-700">
                                Ditolak oleh
                                {{ props.pemilih.verified_by_nama }} pada
                                {{ props.pemilih.verified_at }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    v-if="
                        props.pemilih.status === 'terverifikasi' &&
                        props.pemilih.verified_by_nama
                    "
                    class="border-b border-green-100 bg-green-50/50 p-4"
                >
                    <div class="flex gap-2">
                        ...
                        <div>
                            <p class="text-sm text-green-900">
                                ...
                                pada {{ props.pemilih.verified_at }}
                            </p>
                        </div>
                    </div>
                </div>
    ...
    >
        <div
            class="w-full max-w-md animate-in rounded-xl border border-gray-100 bg-white p-6 shadow-xl duration-200 fade-in"
        >
            <h3 class="text-lg font-bold text-gray-900">
                Alasan Menolak Data Pemilih
            </h3>
            <p class="mt-1.5 text-xs text-gray-500">
                Berikan penjelasan mengapa data pemilih ini ditolak.
            </p>
