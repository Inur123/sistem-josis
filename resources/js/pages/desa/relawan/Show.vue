...
const goToPage = async (page: number) => {
    ...
    try {
        const res = await fetch(
            `/desa/relawan/${props.relawan.id}/pemilihs?page=${page}`,
            {
                headers: {
...
defineOptions({
    layout: {
        breadcrumbs: [
            ...
            { title: 'Data Relawan', href: desaRoutes.relawan.index.url() },
    ...
    <div class="p-6">
        <div class="flex w-full flex-col gap-6">
            ...
            <div class="flex items-center justify-between">
                <Link
                    :href="desaRoutes.relawan.index.url()"
