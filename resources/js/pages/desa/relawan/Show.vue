...
return;
    ...
    try {
        const res = await fetch(`/desa/relawan/${props.relawan.id}/pemilihs?page=${page}`, {
            headers: {
                    ...
                    <table class="w-full text-left text-sm text-gray-500">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <tr
                                ...
                                @click="router.visit(desaRoutes.relawan.pemilih.show.url({ relawan: props.relawan.id, pemilih: p.id }))"
                            >
                                ...
                                <td class="px-4 py-3 text-center">
                                    <div class="flex items-center justify-center">
                                        <Link
                                            :href="desaRoutes.relawan.pemilih.show.url({ relawan: props.relawan.id, pemilih: p.id })"
